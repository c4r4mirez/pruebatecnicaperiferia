...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "PruebaTecnicaPeriferia.MAUI.dll" comes first in this list. */
		"PruebaTecnicaPeriferia.MAUI.dll",
		"AndHUD.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"PruebaTecnicaPeriferia.EFCore.dll",
		"PruebaTecnicaPeriferia.Entities.dll",
		"PruebaTecnicaPeriferia.Http.Service.dll",
